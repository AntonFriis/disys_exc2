...
func (x *LatestId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LatestId) ProtoMessage() {}

func (x *LatestId) ProtoReflect() protoreflect.Message {
	mi := &file_p2p_p2p_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LatestId.ProtoReflect.Descriptor instead.
func (*LatestId) Descriptor() ([]byte, []int) {
	return file_p2p_p2p_proto_rawDescGZIP(), []int{2}
}

func (x *LatestId) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_p2p_p2p_proto_rawDesc = []byte{
	...
	0x03, 0x70, 0x32, 0x70, 0x22, 0x1a, 0x0a, 0x04, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x12, 0x0a, 0x04,
	...
	,
}
...
var file_p2p_p2p_proto_goTypes = []interface{}{
	...
	(*LatestId)(nil), // 2: p2p.LatestId
}
var file_p2p_p2p_proto_depIdxs = []int32{
	0, // 0: p2p.p2pService.Connect:input_type -> p2p.Send
	0, // 1: p2p.p2pService.Disconnect:input_type -> p2p.Send
	1, // 2: p2p.p2pService.Connect:output_type -> p2p.Response
	1, // 3: p2p.p2pService.Disconnect:output_type -> p2p.Response
